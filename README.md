...
The baseline folder contains the work of ```RoDe(CUDA core), Sputnik(CUDA core), TCGNN(TC core), DTC-SpMM(TC core), HC-SpMM(CUDA and TC core), Flashsparse(TC core), and cuSPARSE(CUDA core)```
